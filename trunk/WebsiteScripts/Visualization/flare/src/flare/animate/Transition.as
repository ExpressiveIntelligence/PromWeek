package flare.animate
{
	...
	public class Transition extends EventDispatcher implements ISchedulable
	{
		...
		/** @private */
		//FIXME: I had to do this little hacky thing. 
		// The default parameter for evtType was originally TransitionEvent.END, but it was complaining about
		// compile time constants, so I changed it. 
