package flare.vis.operator.layout
{
	...
	public class TreeMapLayout extends Layout
	{
	    ...
	    private function computeAreas(root:NodeSprite):void
	    {
			...
			/*
			 *Josh McCoy, 13 June 2011
			 * The following code was often dividing by zero and causing the nodes
			 * to have a .props[AREA] == NaN.
			 */
			if (0 == root.props[AREA]) {
				var scale:Number = area;
			}else {
