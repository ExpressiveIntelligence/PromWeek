package  
{
	public class Ending
	{
		 ...
		 */
		public function scoreCompletionProgress(storyLeadCharacter:String):void
		{
			...
			{
				percentTrue = rule.getPercentageTrueForInitiator(cif.cast.getCharByName(storyLeadCharacter))["percent"];
